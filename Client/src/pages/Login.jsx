...
const handleLogin = async function(){
  ...
  return (
    <div className="relative flex w-full h-screen overflow-hidden">
      ...
      {loader && <Loader/>}
      <div
        className={`absolute lg:z-50 top-0 h-full w-1/2 transition-all duration-700 ease-in-out ${
      ...
      <div
        className={`flex items-center justify-center ${isLogin?"w-screen z-10":"w-0"} lg:w-1/2 h-full bg-gradient-to-br from-blue-100 via-white to-blue-200`}
      >
